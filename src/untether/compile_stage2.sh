...
xcrun -sdk iphoneos clang -arch arm64 ../../submodules/libjake/img4lib/libimg4.a ../../submodules/libjake/lib/libjake.a ../shared/realsym.c generator.m install.m stage1.m racoon_www.m uland_offsetfinder.m a64.c stage2.m -I ../ -I ../../submodules/libjake/src/ -I ../../submodules/libjake/img4lib/libvfs/ -DDEBUG -o test -framework Security -framework IOKit -framework CoreFoundation -framework Foundation -L../../submodules/libjake/img4lib/ -L../../submodules/libjake/lib/ && ldid -S../../lailo/lightspeed/Ent.plist test
